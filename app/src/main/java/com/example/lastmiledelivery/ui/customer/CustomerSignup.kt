...
fun CustomerSignupScreen(
    ...
    val signupState by customerViewModel.signupState.observeAsState()
    ...
    Column(
        ...
        Text(text = "Customer Signup", fontSize = 24.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(top=15.dp))
        ...
        Button(
            onClick = {
                ...
                customerViewModel.customerSignup(
                    name.toRequestBody(),
                    email.toRequestBody(),
        ...
        signupState?.let { result ->
            when {
                result.isSuccess -> {
                    ...
                    customerViewModel.clearSignupState()
                }
                result.isFailure -> {
